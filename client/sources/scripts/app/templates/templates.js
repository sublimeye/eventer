angular.module('templates.common', ['partials/auth.html', 'partials/event-edit.html', 'partials/event-view.html', 'partials/home.html', 'partials/profile.html']);
...
angular.module("partials/auth.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("partials/auth.html",
    ...
    "                            <input class=\"form-control\" type=\"text\" placeholder=\"Login\"/></div>\n" +
    "                        <div class=\"form-group\">\n" +
    "                            <input class=\"form-control\" type=\"text\" placeholder=\"Password\"/></div>\n" +
    "                        <div class=\"form-group\">\n" +
    "                            <button class=\"btn btn-default\" type=\"button\">Sign In</button>\n" +
    "                        </div>\n" +
    "                    </form>\n" +
    "                    <div class=\"col-xs-6\">\n" +
    "                        FB VK GG\n" +
...
angular.module("partials/event-edit.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("partials/event-edit.html",
    ...
    "        <div class=\"row\">\n" +
    "            <div class=\"form-group col-sm-6\">\n" +
    "                <label>Where</label> <input class=\"form-control\" placeholder=\"Where...\">\n" +
    "            </div>\n" +
    "        </div>\n" +
    "        <div class=\"row\">\n" +
    "            <div class=\"form-group col-sm-6\">\n" +
    "                <label>Who</label> <input class=\"form-control\" placeholder=\"Invite friends...\">\n" +
    "            </div>\n" +
    "        </div>\n" +
    "        <div class=\"row\">\n" +
    "            <div class=\"form-group col-sm-6\">\n" +
    "                <label>When</label> <input class=\"form-control\" placeholder=\"When: find a time\">\n" +
    "            </div>\n" +
    "        </div>\n" +
    "    </form>\n" +
    "</div>\n" +
...
angular.module("partials/event-view.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("partials/event-view.html",
    "<div class=\"container\">\n" +
    "    <h1>Event: view</h1>\n" +
    "</div>\n" +
    "");
...
angular.module("partials/profile.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("partials/profile.html",
    ...
    "    <div class=\"row mb-2\">\n" +
    "        <div class=\"col-sm-12\">\n" +
    "            <h1>Profile</h1><a href=\"/logout\" class=\"btn btn-default btn-sm\">Sign Out</a>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "\n" +
    "    <div class=\"row\">\n" +
